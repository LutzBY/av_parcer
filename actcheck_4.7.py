...
for row in rows:
    ...
    if response.status_code == 200:
        ...
        try:
            ...
            if (
                seller not in ('Продажа мотоциклов и прицеп дач Вязынка', 'Склад мотоциклов по лучшей цене Вязынка', '29 декабря цены увеличатся на 20% ( на НДС) успей купить.', 'Продажа мотоциклов д.Вязынка')
